...
[TestSubject(typeof(UpdatePermissionHandler))]
public class UpdatePermissionHandlerTests
{
    ...
    {
        _handler = new UpdatePermissionHandler(
    ...
    public async Task Handle_PermissionNotExist_ReturnsPermissionNotFoundError()
    {
        ...
        var command = new UpdatePermissionCommand(
            Guid.NewGuid(),
            PermissionDataFaker.PermissionRequestFaker.Generate());
    ...
    public async Task Handle_PermissionWithGivenNumberAlreadyExists_ReturnsConflictError()
    {
        ...
        var duplicatePermission = PermissionDataFaker
            .PermissionFaker
            .RuleFor(p => p.Number, _ => command.Request.Number)
            .Generate();
        ...
        _permissionRepositoryMock.Setup(
                x =>
                    x.GetByNumberAsync(
                        ...
                        It.IsAny<CancellationToken>()))
            .ReturnsAsync(duplicatePermission);
